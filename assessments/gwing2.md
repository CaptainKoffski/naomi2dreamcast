...
| Assessed | 2026-08-06 · battery v5 · flycast `ebae3b513` · Ghidra 12.1.2_PUBLIC · MAME `59e7c0b`; gate re-run 2026-08-07 · battery v6 · flycast `65f9f7857` (main axis measured, tension 2 resolved — see § Gate) |
...
| ARAM (content, fill-excluded) | 8,372,160 | 2,097,152 | **3.99** | content above cap **48,674 B only** |
...
What would unblock: PIO instrumentation landed in battery v6 (this re-run) and closed
tension 2. What remains is tension 1 — the §6 checkpoint's decision on
address-vs-volume G3-ARAM keying (data argues volume here) — the sole remaining park
driver.
