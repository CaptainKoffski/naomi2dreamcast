...
> **Battery v9 main-content re-score (2026-08-08): 85.9 (S), was 82.2 (S)** — scoring-only blanket re-score, no re-capture: every measurement
...
> the address peak — `nz_total` 4,868,604 B (content-u 0.290) replaces peak 15,728,704 B (u 0.938).
> Memory axis 100.0, binding region now **vram** (was memory 89.7). Verdict section below is the capture-time (v≤8) record.
