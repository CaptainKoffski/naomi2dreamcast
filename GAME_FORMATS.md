...
| Tetris Kiwamemichi (Japan) (GDL-0020) | `tetkiwam` | **GD-ROM** | parent | 62.3 MB | Puzzle ★ | No | **82.9** S · [assessment](assessments/tetkiwam.md) |
...
| Puyo Puyo Da! (Japan) | `puyoda` | **cart** | parent | 111.0 MB | Puzzle ★ | Yes (1999) | **81.9** S · [assessment](assessments/puyoda.md) |
